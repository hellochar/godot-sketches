...
static var definitions: Dictionary = {
  ...
  "hope_beacon": {
    "id": "hope_beacon",
    "name": "Hope Beacon",
    "description": "A light in the darkness. Steadily generates Hope.",
    "behaviors": [Behavior.GENERATOR, Behavior.STORAGE],
    "build_cost": {"energy": 5},
    "size": Vector2i(1, 2),
  ...
  "curiosity_garden": {
    ...
    "description": "A space where wonder grows. Generates Curiosity that can bloom into Insight.",
    "behaviors": [Behavior.GENERATOR, Behavior.STORAGE],
    "build_cost": {"energy": 4},
    "size": Vector2i(2, 2),
  ...
  "memory_archive": {
    "id": "memory_archive",
    "name": "Memory Archive",
    "description": "Deep storage for nostalgia and memories. Large capacity, slow access.",
    "behaviors": [Behavior.STORAGE],
    "build_cost": {"energy": 4},
    "size": Vector2i(2, 2),
  ...
  "quick_cache": {
    "id": "quick_cache",
    "name": "Quick Cache",
    "description": "Small but fast storage. Good for active processing chains.",
    "behaviors": [Behavior.STORAGE],
    "build_cost": {"energy": 2},
    "size": Vector2i(1, 1),
  ...
  "attention_amplifier": {
    ...
    "description": "Increases available attention pool when placed.",
  ...
  "optimism_lens": {
    "id": "optimism_lens",
    "name": "Optimism Lens",
    "description": "Shifts perspective. All positive emotion generation increased.",
    "behaviors": [Behavior.GLOBAL_EFFECT],
    "build_cost": {"energy": 6},
    "size": Vector2i(2, 2),
  ...
  "creative_core": {
    "id": "creative_core",
    "name": "Creative Core",
    "description": "Boosts all habit buildings. Creativity flows more freely.",
    "behaviors": [Behavior.GLOBAL_EFFECT],
    "build_cost": {"energy": 7},
    "size": Vector2i(2, 2),
  ...
  "compassion_center": {
    ...
    "description": "Accelerates all processing buildings. Healing happens faster.",
    "behaviors": [Behavior.GLOBAL_EFFECT],
    "build_cost": {"energy": 7},
    "size": Vector2i(2, 2),
