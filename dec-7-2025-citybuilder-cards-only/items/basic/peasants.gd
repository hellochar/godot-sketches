...
const GRASS = preload("res://dec-7-2025-citybuilder-cards-only/items/basic/grass.tres")
const HUT = preload("res://dec-7-2025-citybuilder-cards-only/items/basic/hut.tres")
const BONES = preload("res://dec-7-2025-citybuilder-cards-only/items/basic/bones.tres")
const STONE = preload("res://dec-7-2025-citybuilder-cards-only/items/basic/stone.tres")
