...
## Lazy singleton that loads all resources from res://dec-7-2025-citybuilder-cards-only/items on first access
## Usage:
...
const RESOURCES_FOLDER = "res://dec-7-2025-citybuilder-cards-only/items"
